...
describe('OpenSCADHoverProvider', () => {
  ...
  describe('provideHover', () => {
    it('should provide hover for module definition', async () => {
      // Position on "cube_with_hole" definition at line 8
      const position = new monaco.Position(9, 8);
    ...
    it('should provide hover for function definition', async () => {
      // Position on "calculate_volume" definition
      const position = new monaco.Position(24, 10);
    ...
    it('should provide hover for variable definition', async () => {
      // Position on "size" variable
      const position = new monaco.Position(29, 1);
  ...
  describe('hover content formatting', () => {
    ...
    it('should provide proper hover range', async () => {
      ...
      expect(hover?.range.startLineNumber).toBe(9);
      expect(hover?.range.endLineNumber).toBe(9);
