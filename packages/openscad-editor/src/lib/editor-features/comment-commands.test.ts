...
describe('OpenSCADCommentService', () => {
  ...
  describe('Factory Function', () => {
    it('should create comment service with default config', () => {
      const { createCommentService } = require('./comment-commands');
    ...
    it('should create comment service with custom config', () => {
      const { createCommentService } = require('./comment-commands');
