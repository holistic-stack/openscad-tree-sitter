...
describe('OpenSCADIndentationProvider', () => {
  ...
  describe('Factory Function', () => {
    it('should create indentation provider with default config', () => {
      const { createIndentationProvider } = require('./indentation-provider');
    ...
    it('should create indentation provider with custom config', () => {
      const { createIndentationProvider } = require('./indentation-provider');
