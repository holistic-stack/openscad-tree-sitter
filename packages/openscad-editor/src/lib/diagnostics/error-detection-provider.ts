...
import { type OpenSCADParserService, type ParseError, type ParseResult } from '../services/openscad-parser-service';
...
export class OpenSCADErrorDetectionProvider {
   ...
   */
  private async detectSemanticErrors(code: string): Promise<ErrorDetectionResult<OpenSCADDiagnostic[]>> {
    try {
