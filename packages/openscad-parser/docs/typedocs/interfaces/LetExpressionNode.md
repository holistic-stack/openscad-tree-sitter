...
Defined in: [openscad-parser/ast/ast-types.ts:905](https://github.com/holistic-stack/openscad-tree-sitter/blob/57470856b239e8ae819e2b2fa40ff65d8c04912f/packages/openscad-parser/src/lib/openscad-parser/ast/ast-types.ts#L905)
...
| <a id="expressiontype"></a> `expressionType` | `"let_expression"` | - | [`ExpressionNode`](ExpressionNode.md).[`expressionType`](ExpressionNode.md#expressiontype) | - | [openscad-parser/ast/ast-types.ts:906](https://github.com/holistic-stack/openscad-tree-sitter/blob/57470856b239e8ae819e2b2fa40ff65d8c04912f/packages/openscad-parser/src/lib/openscad-parser/ast/ast-types.ts#L906) |
| <a id="assignments"></a> `assignments` | [`AssignmentNode`](AssignmentNode.md)[] | - | - | - | [openscad-parser/ast/ast-types.ts:907](https://github.com/holistic-stack/openscad-tree-sitter/blob/57470856b239e8ae819e2b2fa40ff65d8c04912f/packages/openscad-parser/src/lib/openscad-parser/ast/ast-types.ts#L907) |
| <a id="expression"></a> `expression` | [`ExpressionNode`](ExpressionNode.md) \| [`ErrorNode`](ErrorNode.md) | - | - | - | [openscad-parser/ast/ast-types.ts:908](https://github.com/holistic-stack/openscad-tree-sitter/blob/57470856b239e8ae819e2b2fa40ff65d8c04912f/packages/openscad-parser/src/lib/openscad-parser/ast/ast-types.ts#L908) |
