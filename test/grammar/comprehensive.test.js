...
describe('Comprehensive OpenSCAD Grammar Tests', () => {
  ...
  describe('List Comprehensions and Arrays', () => {
    ...
    it('should parse advanced array operations', () => {
      ...
      // Check range expressions in array indexing
      const { ranges } = extractRangeExpressions(code);
  ...
  describe('Edge Cases and Error Recovery', () => {
    ...
    it('should recover from common syntax errors', () => {
      // This test doesn't expect correct parsing, just checking that the parser
      // attempts to recover gracefully without crashing
      const code = `
        // Missing semicolon
        a = 10
        b = 20;
      ...
      `;
      // Just ensure the parser doesn't crash
      const tree = parseCode(code);
      // We expect errors but the tree should still be created
